...
################################################################################
## Form generated from reading UI file 'splash_screenCcFaeC.ui'
##
...
"}")
        ...
        self.texts.setMinimumSize(QSize(0, 0))
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.title.setText(QCoreApplication.translate("SplashScreen", u"EidoData Machine Learning", None))
